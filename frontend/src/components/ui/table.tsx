...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('border-b border-border bg-surface/50 [&_tr]:border-border', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-4 text-left align-middle text-ds-caption font-medium text-muted-foreground',
      className,
    )}
    {...props}
  />
